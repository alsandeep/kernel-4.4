				...
				struct owl_pinctrl_soc_info *info)
{
	...
	printk( KERN_INFO "Actions pinctrl probe\n");
	...
	PINCTRL_DBG("%s() gpio_num_ranges:%d \n",
		__FUNCTION__, info->gpio_num_ranges );
	...
	printk(KERN_INFO "initialized Actions SOC pin control driver\n");

...
#include <linux/soc/owl/powergate.h>
#include <linux/soc/owl/clkname.h>
#include <linux/soc/owl/module-owl.h>
...
int acts_control(struct dma_chan *chan, unsigned long arg)
{
	struct owl_dma_chan	*atchan = to_owl_dma_chan(chan);

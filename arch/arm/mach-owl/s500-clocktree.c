 ...
 */
static struct clk_init_data owl_clks_init[CLOCK__MAX + MOD__MAX_IN_CLK] = {
    [CLOCK__HOSC] = {
...
static struct owl_clk_foo clk_foo_clocks[CLOCK__MAX] = {
    [CLOCK__HOSC] = {
        .hw.init = &owl_clks_init[CLOCK__HOSC],
        .clock = CLOCK__HOSC,
    },
    [CLOCK__IC_32K] = {
        .hw.init = &owl_clks_init[CLOCK__IC_32K],
        .clock = CLOCK__IC_32K,
    },
    [CLOCK__COREPLL] = {
        .hw.init = &owl_clks_init[CLOCK__COREPLL],
        .clock = CLOCK__COREPLL,
    },
    [CLOCK__DEVPLL] = {
        .hw.init = &owl_clks_init[CLOCK__DEVPLL],
        .clock = CLOCK__DEVPLL,
    },
    [CLOCK__DDRPLL] = {
        .hw.init = &owl_clks_init[CLOCK__DDRPLL],
        .clock = CLOCK__DDRPLL,
    },
    [CLOCK__NANDPLL] = {
        .hw.init = &owl_clks_init[CLOCK__NANDPLL],
        .clock = CLOCK__NANDPLL,
    },
    [CLOCK__DISPLAYPLL] = {
        .hw.init = &owl_clks_init[CLOCK__DISPLAYPLL],
        .clock = CLOCK__DISPLAYPLL,
    },
    [CLOCK__AUDIOPLL] = {
        .hw.init = &owl_clks_init[CLOCK__AUDIOPLL],
        .clock = CLOCK__AUDIOPLL,
    },
    [CLOCK__TVOUTPLL] = {
        .hw.init = &owl_clks_init[CLOCK__TVOUTPLL],
        .clock = CLOCK__TVOUTPLL,
    },
    [CLOCK__ETHERNETPLL] = {
        .hw.init = &owl_clks_init[CLOCK__ETHERNETPLL],
        .clock = CLOCK__ETHERNETPLL,
    },
    [CLOCK__CVBSPLL] = {
        .hw.init = &owl_clks_init[CLOCK__CVBSPLL],
        .clock = CLOCK__CVBSPLL,
    },
    [CLOCK__DEV_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__DEV_CLK],
        .clock = CLOCK__DEV_CLK,
    },
    [CLOCK__DDR_CLK_0] = {
        .hw.init = &owl_clks_init[CLOCK__DDR_CLK_0],
        .clock = CLOCK__DDR_CLK_0,
    },
    [CLOCK__DDR_CLK_90] = {
        .hw.init = &owl_clks_init[CLOCK__DDR_CLK_90],
        .clock = CLOCK__DDR_CLK_90,
    },
    [CLOCK__DDR_CLK_180] = {
        .hw.init = &owl_clks_init[CLOCK__DDR_CLK_180],
        .clock = CLOCK__DDR_CLK_180,
    },
    [CLOCK__DDR_CLK_270] = {
        .hw.init = &owl_clks_init[CLOCK__DDR_CLK_270],
        .clock = CLOCK__DDR_CLK_270,
    },
    [CLOCK__DDR_CLK_CH0] = {
        .hw.init = &owl_clks_init[CLOCK__DDR_CLK_CH0],
        .clock = CLOCK__DDR_CLK_CH0,
    },
    [CLOCK__DDR_CLK_CH1] = {
        .hw.init = &owl_clks_init[CLOCK__DDR_CLK_CH1],
        .clock = CLOCK__DDR_CLK_CH1,
    },
    [CLOCK__DDR_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__DDR_CLK],
        .clock = CLOCK__DDR_CLK,
    },
    [CLOCK__SPDIF_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__SPDIF_CLK],
        .clock = CLOCK__SPDIF_CLK,
    },
    [CLOCK__HDMIA_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__HDMIA_CLK],
        .clock = CLOCK__HDMIA_CLK,
    },
    [CLOCK__I2SRX_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__I2SRX_CLK],
        .clock = CLOCK__I2SRX_CLK,
    },
    [CLOCK__I2STX_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__I2STX_CLK],
        .clock = CLOCK__I2STX_CLK,
    },
    [CLOCK__PCM0_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__PCM0_CLK],
        .clock = CLOCK__PCM0_CLK,
    },
    [CLOCK__PCM1_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__PCM1_CLK],
        .clock = CLOCK__PCM1_CLK,
    },
    [CLOCK__CLK_PIXEL] = {
        .hw.init = &owl_clks_init[CLOCK__CLK_PIXEL],
        .clock = CLOCK__CLK_PIXEL,
    },
    [CLOCK__CLK_TMDS] = {
        .hw.init = &owl_clks_init[CLOCK__CLK_TMDS],
        .clock = CLOCK__CLK_TMDS,
    },
    [CLOCK__CLK_TMDS_PHY_P] = {
        .hw.init = &owl_clks_init[CLOCK__CLK_TMDS_PHY_P],
        .clock = CLOCK__CLK_TMDS_PHY_P,
    },
    [CLOCK__L2_NIC_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__L2_NIC_CLK],
        .clock = CLOCK__L2_NIC_CLK,
    },
    [CLOCK__APBDBG_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__APBDBG_CLK],
        .clock = CLOCK__APBDBG_CLK,
    },
    [CLOCK__L2_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__L2_CLK],
        .clock = CLOCK__L2_CLK,
    },
    [CLOCK__ACP_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__ACP_CLK],
        .clock = CLOCK__ACP_CLK,
    },
    [CLOCK__PERIPH_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__PERIPH_CLK],
        .clock = CLOCK__PERIPH_CLK,
    },
    [CLOCK__NIC_DIV_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__NIC_DIV_CLK],
        .clock = CLOCK__NIC_DIV_CLK,
    },
    [CLOCK__NIC_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__NIC_CLK],
        .clock = CLOCK__NIC_CLK,
    },
    [CLOCK__AHBPREDIV_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__AHBPREDIV_CLK],
        .clock = CLOCK__AHBPREDIV_CLK,
    },
    [CLOCK__H_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__H_CLK],
        .clock = CLOCK__H_CLK,
    },
    [CLOCK__APB30_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__APB30_CLK],
        .clock = CLOCK__APB30_CLK,
    },
    [CLOCK__APB20_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__APB20_CLK],
        .clock = CLOCK__APB20_CLK,
    },
    [CLOCK__AHB_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__AHB_CLK],
        .clock = CLOCK__AHB_CLK,
    },
    [CLOCK__CORE_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__CORE_CLK],
        .clock = CLOCK__CORE_CLK,
    },
    [CLOCK__CPU_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__CPU_CLK],
        .clock = CLOCK__CPU_CLK,
    },
    [CLOCK__SENSOR_CLKOUT0] = {
        .hw.init = &owl_clks_init[CLOCK__SENSOR_CLKOUT0],
        .clock = CLOCK__SENSOR_CLKOUT0,
    },
    [CLOCK__SENSOR_CLKOUT1] = {
        .hw.init = &owl_clks_init[CLOCK__SENSOR_CLKOUT1],
        .clock = CLOCK__SENSOR_CLKOUT1,
    },
    [CLOCK__LCD_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__LCD_CLK],
        .clock = CLOCK__LCD_CLK,
    },
    [CLOCK__LVDS_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__LVDS_CLK],
        .clock = CLOCK__LVDS_CLK,
    },
    [CLOCK__CKA_LCD_H] = {
        .hw.init = &owl_clks_init[CLOCK__CKA_LCD_H],
        .clock = CLOCK__CKA_LCD_H,
    },
    [CLOCK__LCD1_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__LCD1_CLK],
        .clock = CLOCK__LCD1_CLK,
    },
    [CLOCK__LCD0_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__LCD0_CLK],
        .clock = CLOCK__LCD0_CLK,
    },
    [CLOCK__DSI_HCLK] = {
        .hw.init = &owl_clks_init[CLOCK__DSI_HCLK],
        .clock = CLOCK__DSI_HCLK,
    },
    [CLOCK__DSI_HCLK90] = {
        .hw.init = &owl_clks_init[CLOCK__DSI_HCLK90],
        .clock = CLOCK__DSI_HCLK90,
    },
    [CLOCK__PRO_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__PRO_CLK],
        .clock = CLOCK__PRO_CLK,
    },
    [CLOCK__PHY_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__PHY_CLK],
        .clock = CLOCK__PHY_CLK,
    },
    [CLOCK__CSI_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__CSI_CLK],
        .clock = CLOCK__CSI_CLK,
    },
    [CLOCK__DE1_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__DE1_CLK],
        .clock = CLOCK__DE1_CLK,
    },
    [CLOCK__DE2_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__DE2_CLK],
        .clock = CLOCK__DE2_CLK,
    },
    [CLOCK__BISP_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__BISP_CLK],
        .clock = CLOCK__BISP_CLK,
    },
    [CLOCK__ISPBP_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__ISPBP_CLK],
        .clock = CLOCK__ISPBP_CLK,
    },
    [CLOCK__IMG5_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__IMG5_CLK],
        .clock = CLOCK__IMG5_CLK,
    },
    [CLOCK__VDE_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__VDE_CLK],
        .clock = CLOCK__VDE_CLK,
    },
    [CLOCK__VCE_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__VCE_CLK],
        .clock = CLOCK__VCE_CLK,
    },
    [CLOCK__NANDC_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__NANDC_CLK],
        .clock = CLOCK__NANDC_CLK,
    },
    [CLOCK__ECC_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__ECC_CLK],
        .clock = CLOCK__ECC_CLK,
    },
    [CLOCK__PRESD0_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__PRESD0_CLK],
        .clock = CLOCK__PRESD0_CLK,
    },
    [CLOCK__PRESD1_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__PRESD1_CLK],
        .clock = CLOCK__PRESD1_CLK,
    },
    [CLOCK__PRESD2_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__PRESD2_CLK],
        .clock = CLOCK__PRESD2_CLK,
    },
    [CLOCK__SD0_CLK_2X] = {
        .hw.init = &owl_clks_init[CLOCK__SD0_CLK_2X],
        .clock = CLOCK__SD0_CLK_2X,
    },
    [CLOCK__SD1_CLK_2X] = {
        .hw.init = &owl_clks_init[CLOCK__SD1_CLK_2X],
        .clock = CLOCK__SD1_CLK_2X,
    },
    [CLOCK__SD2_CLK_2X] = {
        .hw.init = &owl_clks_init[CLOCK__SD2_CLK_2X],
        .clock = CLOCK__SD2_CLK_2X,
    },
    [CLOCK__SD0_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__SD0_CLK],
        .clock = CLOCK__SD0_CLK,
    },
    [CLOCK__SD1_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__SD1_CLK],
        .clock = CLOCK__SD1_CLK,
    },
    [CLOCK__SD2_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__SD2_CLK],
        .clock = CLOCK__SD2_CLK,
    },
    [CLOCK__UART0_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__UART0_CLK],
        .clock = CLOCK__UART0_CLK,
    },
    [CLOCK__UART1_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__UART1_CLK],
        .clock = CLOCK__UART1_CLK,
    },
    [CLOCK__UART2_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__UART2_CLK],
        .clock = CLOCK__UART2_CLK,
    },
    [CLOCK__UART3_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__UART3_CLK],
        .clock = CLOCK__UART3_CLK,
    },
    [CLOCK__UART4_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__UART4_CLK],
        .clock = CLOCK__UART4_CLK,
    },
    [CLOCK__UART5_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__UART5_CLK],
        .clock = CLOCK__UART5_CLK,
    },
    [CLOCK__UART6_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__UART6_CLK],
        .clock = CLOCK__UART6_CLK,
    },
    [CLOCK__PWM0_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__PWM0_CLK],
        .clock = CLOCK__PWM0_CLK,
    },
    [CLOCK__PWM1_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__PWM1_CLK],
        .clock = CLOCK__PWM1_CLK,
    },
    [CLOCK__PWM2_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__PWM2_CLK],
        .clock = CLOCK__PWM2_CLK,
    },
    [CLOCK__PWM3_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__PWM3_CLK],
        .clock = CLOCK__PWM3_CLK,
    },
    [CLOCK__PWM4_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__PWM4_CLK],
        .clock = CLOCK__PWM4_CLK,
    },
    [CLOCK__PWM5_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__PWM5_CLK],
        .clock = CLOCK__PWM5_CLK,
    },
    [CLOCK__RMII_REF_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__RMII_REF_CLK],
        .clock = CLOCK__RMII_REF_CLK,
    },
    [CLOCK__I2C0_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__I2C0_CLK],
        .clock = CLOCK__I2C0_CLK,
    },
    [CLOCK__I2C1_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__I2C1_CLK],
        .clock = CLOCK__I2C1_CLK,
    },
    [CLOCK__I2C2_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__I2C2_CLK],
        .clock = CLOCK__I2C2_CLK,
    },
    [CLOCK__I2C3_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__I2C3_CLK],
        .clock = CLOCK__I2C3_CLK,
    },
    [CLOCK__25M_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__25M_CLK],
        .clock = CLOCK__25M_CLK,
    },
    [CLOCK__LENS_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__LENS_CLK],
        .clock = CLOCK__LENS_CLK,
    },
    [CLOCK__HDMI24M] = {
        .hw.init = &owl_clks_init[CLOCK__HDMI24M],
        .clock = CLOCK__HDMI24M,
    },
    [CLOCK__TIMER_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__TIMER_CLK],
        .clock = CLOCK__TIMER_CLK,
    },
    [CLOCK__SS_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__SS_CLK],
        .clock = CLOCK__SS_CLK,
    },
    [CLOCK__SPS_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__SPS_CLK],
        .clock = CLOCK__SPS_CLK,
    },
    [CLOCK__IRC_CLK] = {
        .hw.init = &owl_clks_init[CLOCK__IRC_CLK],
        .clock = CLOCK__IRC_CLK,
    },
    [CLOCK__TV24M] = {
        .hw.init = &owl_clks_init[CLOCK__TV24M],
        .clock = CLOCK__TV24M,
    },
    [CLOCK__CVBS_CLK108M] = {
        .hw.init = &owl_clks_init[CLOCK__CVBS_CLK108M],
        .clock = CLOCK__CVBS_CLK108M,
    },
    [CLOCK__MIPI24M] = {
        .hw.init = &owl_clks_init[CLOCK__MIPI24M],
        .clock = CLOCK__MIPI24M,
    },
    [CLOCK__LENS24M] = {
        .hw.init = &owl_clks_init[CLOCK__LENS24M],
        .clock = CLOCK__LENS24M,
    },
    [CLOCK__GPU3D_SYSCLK] = {
        .hw.init = &owl_clks_init[CLOCK__GPU3D_SYSCLK],
        .clock = CLOCK__GPU3D_SYSCLK,
    },
    [CLOCK__GPU3D_HYDCLK] = {
        .hw.init = &owl_clks_init[CLOCK__GPU3D_HYDCLK],
        .clock = CLOCK__GPU3D_HYDCLK,
    },
    [CLOCK__GPU3D_NIC_MEMCLK] = {
        .hw.init = &owl_clks_init[CLOCK__GPU3D_NIC_MEMCLK],
        .clock = CLOCK__GPU3D_NIC_MEMCLK,
    },
    [CLOCK__GPU3D_CORECLK] = {
        .hw.init = &owl_clks_init[CLOCK__GPU3D_CORECLK],
...
static struct  owl_clk_foo clk_foo_modules[MOD__MAX_IN_CLK] = {
    [MOD__ROOT] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__ROOT],
        .clock = MOD__ROOT,
    },
    [MOD__GPU3D] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__GPU3D],
        .clock = MOD__GPU3D,
    },
    [MOD__SHARESRAM] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__SHARESRAM],
        .clock = MOD__SHARESRAM,
    },
    [MOD__HDCP2X] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__HDCP2X],
        .clock = MOD__HDCP2X,
    },
    [MOD__VCE] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__VCE],
        .clock = MOD__VCE,
    },
    [MOD__VDE] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__VDE],
        .clock = MOD__VDE,
    },
    [MOD__PCM0] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__PCM0],
        .clock = MOD__PCM0,
    },
    [MOD__SPDIF] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__SPDIF],
        .clock = MOD__SPDIF,
    },
    [MOD__HDMIA] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__HDMIA],
        .clock = MOD__HDMIA,
    },
    [MOD__I2SRX] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__I2SRX],
        .clock = MOD__I2SRX,
    },
    [MOD__I2STX] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__I2STX],
        .clock = MOD__I2STX,
    },
    [MOD__GPIO] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__GPIO],
        .clock = MOD__GPIO,
    },
    [MOD__KEY] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__KEY],
        .clock = MOD__KEY,
    },
    [MOD__LENS] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__LENS],
        .clock = MOD__LENS,
    },
    [MOD__BISP] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__BISP],
        .clock = MOD__BISP,
    },
    [MOD__CSI] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__CSI],
        .clock = MOD__CSI,
    },
    [MOD__DSI] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__DSI],
        .clock = MOD__DSI,
    },
    [MOD__LVDS] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__LVDS],
        .clock = MOD__LVDS,
    },
    [MOD__LCD1] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__LCD1],
        .clock = MOD__LCD1,
    },
    [MOD__LCD0] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__LCD0],
        .clock = MOD__LCD0,
    },
    [MOD__DE] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__DE],
        .clock = MOD__DE,
    },
    [MOD__SD2] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__SD2],
        .clock = MOD__SD2,
    },
    [MOD__SD1] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__SD1],
        .clock = MOD__SD1,
    },
    [MOD__SD0] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__SD0],
        .clock = MOD__SD0,
    },
    [MOD__NANDC] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__NANDC],
        .clock = MOD__NANDC,
    },
    [MOD__DDRCH0] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__DDRCH0],
        .clock = MOD__DDRCH0,
    },
    [MOD__NOR] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__NOR],
        .clock = MOD__NOR,
    },
    [MOD__DMAC] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__DMAC],
        .clock = MOD__DMAC,
    },
    [MOD__DDRCH1] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__DDRCH1],
        .clock = MOD__DDRCH1,
    },
    [MOD__I2C3] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__I2C3],
        .clock = MOD__I2C3,
    },
    [MOD__I2C2] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__I2C2],
        .clock = MOD__I2C2,
    },
    [MOD__TIMER] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__TIMER],
        .clock = MOD__TIMER,
    },
    [MOD__PWM5] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__PWM5],
        .clock = MOD__PWM5,
    },
    [MOD__PWM4] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__PWM4],
        .clock = MOD__PWM4,
    },
    [MOD__PWM3] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__PWM3],
        .clock = MOD__PWM3,
    },
    [MOD__PWM2] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__PWM2],
        .clock = MOD__PWM2,
    },
    [MOD__PWM1] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__PWM1],
        .clock = MOD__PWM1,
    },
    [MOD__PWM0] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__PWM0],
        .clock = MOD__PWM0,
    },
    [MOD__ETHERNET] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__ETHERNET],
        .clock = MOD__ETHERNET,
    },
    [MOD__UART5] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__UART5],
        .clock = MOD__UART5,
    },
    [MOD__UART4] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__UART4],
        .clock = MOD__UART4,
    },
    [MOD__UART3] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__UART3],
        .clock = MOD__UART3,
    },
    [MOD__UART6] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__UART6],
        .clock = MOD__UART6,
    },
    [MOD__PCM1] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__PCM1],
        .clock = MOD__PCM1,
    },
    [MOD__I2C1] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__I2C1],
        .clock = MOD__I2C1,
    },
    [MOD__I2C0] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__I2C0],
        .clock = MOD__I2C0,
    },
    [MOD__SPI3] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__SPI3],
        .clock = MOD__SPI3,
    },
    [MOD__SPI2] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__SPI2],
        .clock = MOD__SPI2,
    },
    [MOD__SPI1] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__SPI1],
        .clock = MOD__SPI1,
    },
    [MOD__SPI0] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__SPI0],
        .clock = MOD__SPI0,
    },
    [MOD__IRC] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__IRC],
        .clock = MOD__IRC,
    },
    [MOD__UART2] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__UART2],
        .clock = MOD__UART2,
    },
    [MOD__UART1] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__UART1],
        .clock = MOD__UART1,
    },
    [MOD__UART0] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__UART0],
        .clock = MOD__UART0,
    },
    [MOD__HDMI] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__HDMI],
        .clock = MOD__HDMI,
    },
    [MOD__SS] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__SS],
        .clock = MOD__SS,
    },
    [MOD__TV24M] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__TV24M],
        .clock = MOD__TV24M,
    },
    [MOD__CVBS_CLK108M] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__CVBS_CLK108M],
        .clock = MOD__CVBS_CLK108M,
    },
    [MOD__TVOUT] = {
        .hw.init = &owl_clks_init[CLOCK__MAX + MOD__TVOUT],
        .clock = MOD__TVOUT,
    },
};
...
static struct clk_lookup lookup_table[CLOCK__MAX + MOD__MAX_IN_CLK] = {
    [CLOCK__HOSC] = {
        ...
        .clk_hw = &clk_foo_clocks[CLOCK__HOSC].hw,
    },
    [CLOCK__IC_32K] = {
        .con_id = clocks[CLOCK__IC_32K].name,
        .clk_hw = &clk_foo_clocks[CLOCK__IC_32K].hw,
    },
    [CLOCK__COREPLL] = {
        .con_id = clocks[CLOCK__COREPLL].name,
        .clk_hw = &clk_foo_clocks[CLOCK__COREPLL].hw,
    },
    [CLOCK__DEVPLL] = {
        .con_id = clocks[CLOCK__DEVPLL].name,
        .clk_hw = &clk_foo_clocks[CLOCK__DEVPLL].hw,
    },
    [CLOCK__DDRPLL] = {
        .con_id = clocks[CLOCK__DDRPLL].name,
        .clk_hw = &clk_foo_clocks[CLOCK__DDRPLL].hw,
    },
    [CLOCK__NANDPLL] = {
        .con_id = NULL, /* hide nandpll to ease debug work */
        .clk_hw = &clk_foo_clocks[CLOCK__NANDPLL].hw,
    },
    [CLOCK__DISPLAYPLL] = {
        .con_id = clocks[CLOCK__DISPLAYPLL].name,
        .clk_hw = &clk_foo_clocks[CLOCK__DISPLAYPLL].hw,
    },
    [CLOCK__AUDIOPLL] = {
        .con_id = clocks[CLOCK__AUDIOPLL].name,
        .clk_hw = &clk_foo_clocks[CLOCK__AUDIOPLL].hw,
    },
    [CLOCK__TVOUTPLL] = {
        .con_id = clocks[CLOCK__TVOUTPLL].name,
        .clk_hw = &clk_foo_clocks[CLOCK__TVOUTPLL].hw,
    },
    [CLOCK__ETHERNETPLL] = {
        .con_id = clocks[CLOCK__ETHERNETPLL].name,
        .clk_hw = &clk_foo_clocks[CLOCK__ETHERNETPLL].hw,
    },
    [CLOCK__CVBSPLL] = {
        .con_id = clocks[CLOCK__CVBSPLL].name,
        .clk_hw = &clk_foo_clocks[CLOCK__CVBSPLL].hw,
    },
    [CLOCK__DEV_CLK] = {
        .con_id = clocks[CLOCK__DEV_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__DEV_CLK].hw,
    },
    [CLOCK__DDR_CLK_0] = {
        .con_id = clocks[CLOCK__DDR_CLK_0].name,
        .clk_hw = &clk_foo_clocks[CLOCK__DDR_CLK_0].hw,
    },
    [CLOCK__DDR_CLK_90] = {
        .con_id = clocks[CLOCK__DDR_CLK_90].name,
        .clk_hw = &clk_foo_clocks[CLOCK__DDR_CLK_90].hw,
    },
    [CLOCK__DDR_CLK_180] = {
        .con_id = clocks[CLOCK__DDR_CLK_180].name,
        .clk_hw = &clk_foo_clocks[CLOCK__DDR_CLK_180].hw,
    },
    [CLOCK__DDR_CLK_270] = {
        .con_id = clocks[CLOCK__DDR_CLK_270].name,
        .clk_hw = &clk_foo_clocks[CLOCK__DDR_CLK_270].hw,
    },
    [CLOCK__DDR_CLK_CH0] = {
        .con_id = clocks[CLOCK__DDR_CLK_CH0].name,
        .clk_hw = &clk_foo_clocks[CLOCK__DDR_CLK_CH0].hw,
    },
    [CLOCK__DDR_CLK_CH1] = {
        .con_id = clocks[CLOCK__DDR_CLK_CH1].name,
        .clk_hw = &clk_foo_clocks[CLOCK__DDR_CLK_CH1].hw,
    },
    [CLOCK__DDR_CLK] = {
        .con_id = clocks[CLOCK__DDR_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__DDR_CLK].hw,
    },
    [CLOCK__SPDIF_CLK] = {
        .con_id = clocks[CLOCK__SPDIF_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__SPDIF_CLK].hw,
    },
    [CLOCK__HDMIA_CLK] = {
        .con_id = clocks[CLOCK__HDMIA_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__HDMIA_CLK].hw,
    },
    [CLOCK__I2SRX_CLK] = {
        .con_id = clocks[CLOCK__I2SRX_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__I2SRX_CLK].hw,
    },
    [CLOCK__I2STX_CLK] = {
        .con_id = clocks[CLOCK__I2STX_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__I2STX_CLK].hw,
    },
    [CLOCK__PCM0_CLK] = {
        .con_id = clocks[CLOCK__PCM0_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__PCM0_CLK].hw,
    },
    [CLOCK__PCM1_CLK] = {
        .con_id = clocks[CLOCK__PCM1_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__PCM1_CLK].hw,
    },
    [CLOCK__CLK_PIXEL] = {
        .con_id = clocks[CLOCK__CLK_PIXEL].name,
        .clk_hw = &clk_foo_clocks[CLOCK__CLK_PIXEL].hw,
    },
    [CLOCK__CLK_TMDS] = {
        .con_id = clocks[CLOCK__CLK_TMDS].name,
        .clk_hw = &clk_foo_clocks[CLOCK__CLK_TMDS].hw,
    },
    [CLOCK__CLK_TMDS_PHY_P] = {
        .con_id = clocks[CLOCK__CLK_TMDS_PHY_P].name,
        .clk_hw = &clk_foo_clocks[CLOCK__CLK_TMDS_PHY_P].hw,
    },
    [CLOCK__L2_NIC_CLK] = {
        .con_id = clocks[CLOCK__L2_NIC_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__L2_NIC_CLK].hw,
    },
    [CLOCK__APBDBG_CLK] = {
        .con_id = clocks[CLOCK__APBDBG_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__APBDBG_CLK].hw,
    },
    [CLOCK__L2_CLK] = {
        .con_id = clocks[CLOCK__L2_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__L2_CLK].hw,
    },
    [CLOCK__ACP_CLK] = {
        .con_id = clocks[CLOCK__ACP_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__ACP_CLK].hw,
    },
    [CLOCK__PERIPH_CLK] = {
        .con_id = clocks[CLOCK__PERIPH_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__PERIPH_CLK].hw,
    },
    [CLOCK__NIC_DIV_CLK] = {
        .con_id = clocks[CLOCK__NIC_DIV_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__NIC_DIV_CLK].hw,
    },
    [CLOCK__NIC_CLK] = {
        .con_id = clocks[CLOCK__NIC_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__NIC_CLK].hw,
    },
    [CLOCK__AHBPREDIV_CLK] = {
        .con_id = clocks[CLOCK__AHBPREDIV_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__AHBPREDIV_CLK].hw,
    },
    [CLOCK__H_CLK] = {
        .con_id = clocks[CLOCK__H_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__H_CLK].hw,
    },
    [CLOCK__APB30_CLK] = {
        .con_id = clocks[CLOCK__APB30_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__APB30_CLK].hw,
    },
    [CLOCK__APB20_CLK] = {
        .con_id = clocks[CLOCK__APB20_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__APB20_CLK].hw,
    },
    [CLOCK__AHB_CLK] = {
        .con_id = clocks[CLOCK__AHB_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__AHB_CLK].hw,
    },
    [CLOCK__CORE_CLK] = {
        .con_id = clocks[CLOCK__CORE_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__CORE_CLK].hw,
    },
    [CLOCK__CPU_CLK] = {
        .con_id = clocks[CLOCK__CPU_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__CPU_CLK].hw,
    },
    [CLOCK__SENSOR_CLKOUT0] = {
        .con_id = clocks[CLOCK__SENSOR_CLKOUT0].name,
        .clk_hw = &clk_foo_clocks[CLOCK__SENSOR_CLKOUT0].hw,
    },
    [CLOCK__SENSOR_CLKOUT1] = {
        .con_id = clocks[CLOCK__SENSOR_CLKOUT1].name,
        .clk_hw = &clk_foo_clocks[CLOCK__SENSOR_CLKOUT1].hw,
    },
    [CLOCK__LCD_CLK] = {
        .con_id = clocks[CLOCK__LCD_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__LCD_CLK].hw,
    },
    [CLOCK__LVDS_CLK] = {
        .con_id = clocks[CLOCK__LVDS_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__LVDS_CLK].hw,
    },
    [CLOCK__CKA_LCD_H] = {
        .con_id = clocks[CLOCK__CKA_LCD_H].name,
        .clk_hw = &clk_foo_clocks[CLOCK__CKA_LCD_H].hw,
    },
    [CLOCK__LCD1_CLK] = {
        .con_id = clocks[CLOCK__LCD1_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__LCD1_CLK].hw,
    },
    [CLOCK__LCD0_CLK] = {
        .con_id = clocks[CLOCK__LCD0_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__LCD0_CLK].hw,
    },
    [CLOCK__DSI_HCLK] = {
        .con_id = clocks[CLOCK__DSI_HCLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__DSI_HCLK].hw,
    },
    [CLOCK__DSI_HCLK90] = {
        .con_id = clocks[CLOCK__DSI_HCLK90].name,
        .clk_hw = &clk_foo_clocks[CLOCK__DSI_HCLK90].hw,
    },
    [CLOCK__PRO_CLK] = {
        .con_id = clocks[CLOCK__PRO_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__PRO_CLK].hw,
    },
    [CLOCK__PHY_CLK] = {
        .con_id = clocks[CLOCK__PHY_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__PHY_CLK].hw,
    },
    [CLOCK__CSI_CLK] = {
        .con_id = clocks[CLOCK__CSI_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__CSI_CLK].hw,
    },
    [CLOCK__DE1_CLK] = {
        .con_id = clocks[CLOCK__DE1_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__DE1_CLK].hw,
    },
    [CLOCK__DE2_CLK] = {
        .con_id = clocks[CLOCK__DE2_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__DE2_CLK].hw,
    },
    [CLOCK__BISP_CLK] = {
        .con_id = clocks[CLOCK__BISP_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__BISP_CLK].hw,
    },
    [CLOCK__ISPBP_CLK] = {
        .con_id = clocks[CLOCK__ISPBP_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__ISPBP_CLK].hw,
    },
    [CLOCK__IMG5_CLK] = {
        .con_id = clocks[CLOCK__IMG5_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__IMG5_CLK].hw,
    },
    [CLOCK__VDE_CLK] = {
        .con_id = clocks[CLOCK__VDE_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__VDE_CLK].hw,
    },
    [CLOCK__VCE_CLK] = {
        .con_id = clocks[CLOCK__VCE_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__VCE_CLK].hw,
    },
    [CLOCK__NANDC_CLK] = {
        .con_id = clocks[CLOCK__NANDC_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__NANDC_CLK].hw,
    },
    [CLOCK__ECC_CLK] = {
        .con_id = clocks[CLOCK__ECC_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__ECC_CLK].hw,
    },
    [CLOCK__PRESD0_CLK] = {
        .con_id = clocks[CLOCK__PRESD0_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__PRESD0_CLK].hw,
    },
    [CLOCK__PRESD1_CLK] = {
        .con_id = clocks[CLOCK__PRESD1_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__PRESD1_CLK].hw,
    },
    [CLOCK__PRESD2_CLK] = {
        .con_id = clocks[CLOCK__PRESD2_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__PRESD2_CLK].hw,
    },
    [CLOCK__SD0_CLK_2X] = {
        .con_id = clocks[CLOCK__SD0_CLK_2X].name,
        .clk_hw = &clk_foo_clocks[CLOCK__SD0_CLK_2X].hw,
    },
    [CLOCK__SD1_CLK_2X] = {
        .con_id = clocks[CLOCK__SD1_CLK_2X].name,
        .clk_hw = &clk_foo_clocks[CLOCK__SD1_CLK_2X].hw,
    },
    [CLOCK__SD2_CLK_2X] = {
        .con_id = clocks[CLOCK__SD2_CLK_2X].name,
        .clk_hw = &clk_foo_clocks[CLOCK__SD2_CLK_2X].hw,
    },
    [CLOCK__SD0_CLK] = {
        .con_id = clocks[CLOCK__SD0_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__SD0_CLK].hw,
    },
    [CLOCK__SD1_CLK] = {
        .con_id = clocks[CLOCK__SD1_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__SD1_CLK].hw,
    },
    [CLOCK__SD2_CLK] = {
        .con_id = clocks[CLOCK__SD2_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__SD2_CLK].hw,
    },
    [CLOCK__UART0_CLK] = {
        .con_id = clocks[CLOCK__UART0_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__UART0_CLK].hw,
    },
    [CLOCK__UART1_CLK] = {
        .con_id = clocks[CLOCK__UART1_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__UART1_CLK].hw,
    },
    [CLOCK__UART2_CLK] = {
        .con_id = clocks[CLOCK__UART2_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__UART2_CLK].hw,
    },
    [CLOCK__UART3_CLK] = {
        .con_id = clocks[CLOCK__UART3_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__UART3_CLK].hw,
    },
    [CLOCK__UART4_CLK] = {
        .con_id = clocks[CLOCK__UART4_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__UART4_CLK].hw,
    },
    [CLOCK__UART5_CLK] = {
        .con_id = clocks[CLOCK__UART5_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__UART5_CLK].hw,
    },
    [CLOCK__UART6_CLK] = {
        .con_id = clocks[CLOCK__UART6_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__UART6_CLK].hw,
    },
    [CLOCK__PWM0_CLK] = {
        .con_id = clocks[CLOCK__PWM0_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__PWM0_CLK].hw,
    },
    [CLOCK__PWM1_CLK] = {
        .con_id = clocks[CLOCK__PWM1_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__PWM1_CLK].hw,
    },
    [CLOCK__PWM2_CLK] = {
        .con_id = clocks[CLOCK__PWM2_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__PWM2_CLK].hw,
    },
    [CLOCK__PWM3_CLK] = {
        .con_id = clocks[CLOCK__PWM3_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__PWM3_CLK].hw,
    },
    [CLOCK__PWM4_CLK] = {
        .con_id = clocks[CLOCK__PWM4_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__PWM4_CLK].hw,
    },
    [CLOCK__PWM5_CLK] = {
        .con_id = clocks[CLOCK__PWM5_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__PWM5_CLK].hw,
    },
    [CLOCK__RMII_REF_CLK] = {
        .con_id = clocks[CLOCK__RMII_REF_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__RMII_REF_CLK].hw,
    },
    [CLOCK__I2C0_CLK] = {
        .con_id = clocks[CLOCK__I2C0_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__I2C0_CLK].hw,
    },
    [CLOCK__I2C1_CLK] = {
        .con_id = clocks[CLOCK__I2C1_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__I2C1_CLK].hw,
    },
    [CLOCK__I2C2_CLK] = {
        .con_id = clocks[CLOCK__I2C2_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__I2C2_CLK].hw,
    },
    [CLOCK__I2C3_CLK] = {
        .con_id = clocks[CLOCK__I2C3_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__I2C3_CLK].hw,
    },
    [CLOCK__25M_CLK] = {
        .con_id = clocks[CLOCK__25M_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__25M_CLK].hw,
    },
    [CLOCK__LENS_CLK] = {
        .con_id = clocks[CLOCK__LENS_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__LENS_CLK].hw,
    },
    [CLOCK__HDMI24M] = {
        .con_id = clocks[CLOCK__HDMI24M].name,
        .clk_hw = &clk_foo_clocks[CLOCK__HDMI24M].hw,
    },
    [CLOCK__TIMER_CLK] = {
        .con_id = clocks[CLOCK__TIMER_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__TIMER_CLK].hw,
    },
    [CLOCK__SS_CLK] = {
        .con_id = clocks[CLOCK__SS_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__SS_CLK].hw,
    },
    [CLOCK__SPS_CLK] = {
        .con_id = clocks[CLOCK__SPS_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__SPS_CLK].hw,
    },
    [CLOCK__IRC_CLK] = {
        .con_id = clocks[CLOCK__IRC_CLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__IRC_CLK].hw,
    },
    [CLOCK__TV24M] = {
        .con_id = clocks[CLOCK__TV24M].name,
        .clk_hw = &clk_foo_clocks[CLOCK__TV24M].hw,
    },
    [CLOCK__CVBS_CLK108M] = {
        .con_id = clocks[CLOCK__CVBS_CLK108M].name,
        .clk_hw = &clk_foo_clocks[CLOCK__CVBS_CLK108M].hw,
    },
    [CLOCK__MIPI24M] = {
        .con_id = clocks[CLOCK__MIPI24M].name,
        .clk_hw = &clk_foo_clocks[CLOCK__MIPI24M].hw,
    },
    [CLOCK__LENS24M] = {
        .con_id = clocks[CLOCK__LENS24M].name,
        .clk_hw = &clk_foo_clocks[CLOCK__LENS24M].hw,
    },
    [CLOCK__GPU3D_SYSCLK] = {
        .con_id = clocks[CLOCK__GPU3D_SYSCLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__GPU3D_SYSCLK].hw,
    },
    [CLOCK__GPU3D_HYDCLK] = {
        .con_id = clocks[CLOCK__GPU3D_HYDCLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__GPU3D_HYDCLK].hw,
    },
    [CLOCK__GPU3D_NIC_MEMCLK] = {
        .con_id = clocks[CLOCK__GPU3D_NIC_MEMCLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__GPU3D_NIC_MEMCLK].hw,
    },
    [CLOCK__GPU3D_CORECLK] = {
        .con_id = clocks[CLOCK__GPU3D_CORECLK].name,
        .clk_hw = &clk_foo_clocks[CLOCK__GPU3D_CORECLK].hw,
    },
    [CLOCK__MAX + MOD__ROOT] = {
        .con_id = modnode[MOD__ROOT].modname,
        .clk_hw = &clk_foo_modules[MOD__ROOT].hw,
    },
    [CLOCK__MAX + MOD__GPU3D] = {
        .con_id = modnode[MOD__GPU3D].modname,
        .clk_hw = &clk_foo_modules[MOD__GPU3D].hw,
    },
    [CLOCK__MAX + MOD__SHARESRAM] = {
        .con_id = modnode[MOD__SHARESRAM].modname,
        .clk_hw = &clk_foo_modules[MOD__SHARESRAM].hw,
    },
    [CLOCK__MAX + MOD__HDCP2X] = {
        .con_id = modnode[MOD__HDCP2X].modname,
        .clk_hw = &clk_foo_modules[MOD__HDCP2X].hw,
    },
    [CLOCK__MAX + MOD__VCE] = {
        .con_id = modnode[MOD__VCE].modname,
        .clk_hw = &clk_foo_modules[MOD__VCE].hw,
    },
    [CLOCK__MAX + MOD__VDE] = {
        .con_id = modnode[MOD__VDE].modname,
        .clk_hw = &clk_foo_modules[MOD__VDE].hw,
    },
    [CLOCK__MAX + MOD__PCM0] = {
        .con_id = modnode[MOD__PCM0].modname,
        .clk_hw = &clk_foo_modules[MOD__PCM0].hw,
    },
    [CLOCK__MAX + MOD__SPDIF] = {
        .con_id = modnode[MOD__SPDIF].modname,
        .clk_hw = &clk_foo_modules[MOD__SPDIF].hw,
    },
    [CLOCK__MAX + MOD__HDMIA] = {
        .con_id = modnode[MOD__HDMIA].modname,
        .clk_hw = &clk_foo_modules[MOD__HDMIA].hw,
    },
    [CLOCK__MAX + MOD__I2SRX] = {
        .con_id = modnode[MOD__I2SRX].modname,
        .clk_hw = &clk_foo_modules[MOD__I2SRX].hw,
    },
    [CLOCK__MAX + MOD__I2STX] = {
        .con_id = modnode[MOD__I2STX].modname,
        .clk_hw = &clk_foo_modules[MOD__I2STX].hw,
    },
    [CLOCK__MAX + MOD__GPIO] = {
        .con_id = modnode[MOD__GPIO].modname,
        .clk_hw = &clk_foo_modules[MOD__GPIO].hw,
    },
    [CLOCK__MAX + MOD__KEY] = {
        .con_id = modnode[MOD__KEY].modname,
        .clk_hw = &clk_foo_modules[MOD__KEY].hw,
    },
    [CLOCK__MAX + MOD__LENS] = {
        .con_id = modnode[MOD__LENS].modname,
        .clk_hw = &clk_foo_modules[MOD__LENS].hw,
    },
    [CLOCK__MAX + MOD__BISP] = {
        .con_id = modnode[MOD__BISP].modname,
        .clk_hw = &clk_foo_modules[MOD__BISP].hw,
    },
    [CLOCK__MAX + MOD__CSI] = {
        .con_id = modnode[MOD__CSI].modname,
        .clk_hw = &clk_foo_modules[MOD__CSI].hw,
    },
    [CLOCK__MAX + MOD__DSI] = {
        .con_id = modnode[MOD__DSI].modname,
        .clk_hw = &clk_foo_modules[MOD__DSI].hw,
    },
    [CLOCK__MAX + MOD__LVDS] = {
        .con_id = modnode[MOD__LVDS].modname,
        .clk_hw = &clk_foo_modules[MOD__LVDS].hw,
    },
    [CLOCK__MAX + MOD__LCD1] = {
        .con_id = modnode[MOD__LCD1].modname,
        .clk_hw = &clk_foo_modules[MOD__LCD1].hw,
    },
    [CLOCK__MAX + MOD__LCD0] = {
        .con_id = modnode[MOD__LCD0].modname,
        .clk_hw = &clk_foo_modules[MOD__LCD0].hw,
    },
    [CLOCK__MAX + MOD__DE] = {
        .con_id = modnode[MOD__DE].modname,
        .clk_hw = &clk_foo_modules[MOD__DE].hw,
    },
    [CLOCK__MAX + MOD__SD2] = {
        .con_id = modnode[MOD__SD2].modname,
        .clk_hw = &clk_foo_modules[MOD__SD2].hw,
    },
    [CLOCK__MAX + MOD__SD1] = {
        .con_id = modnode[MOD__SD1].modname,
        .clk_hw = &clk_foo_modules[MOD__SD1].hw,
    },
    [CLOCK__MAX + MOD__SD0] = {
        .con_id = modnode[MOD__SD0].modname,
        .clk_hw = &clk_foo_modules[MOD__SD0].hw,
    },
    [CLOCK__MAX + MOD__NANDC] = {
        .con_id = modnode[MOD__NANDC].modname,
        .clk_hw = &clk_foo_modules[MOD__NANDC].hw,
    },
    [CLOCK__MAX + MOD__DDRCH0] = {
        .con_id = modnode[MOD__DDRCH0].modname,
        .clk_hw = &clk_foo_modules[MOD__DDRCH0].hw,
    },
    [CLOCK__MAX + MOD__NOR] = {
        .con_id = modnode[MOD__NOR].modname,
        .clk_hw = &clk_foo_modules[MOD__NOR].hw,
    },
    [CLOCK__MAX + MOD__DMAC] = {
        .con_id = modnode[MOD__DMAC].modname,
        .clk_hw = &clk_foo_modules[MOD__DMAC].hw,
    },
    [CLOCK__MAX + MOD__DDRCH1] = {
        .con_id = modnode[MOD__DDRCH1].modname,
        .clk_hw = &clk_foo_modules[MOD__DDRCH1].hw,
    },
    [CLOCK__MAX + MOD__I2C3] = {
        .con_id = modnode[MOD__I2C3].modname,
        .clk_hw = &clk_foo_modules[MOD__I2C3].hw,
    },
    [CLOCK__MAX + MOD__I2C2] = {
        .con_id = modnode[MOD__I2C2].modname,
        .clk_hw = &clk_foo_modules[MOD__I2C2].hw,
    },
    [CLOCK__MAX + MOD__TIMER] = {
        .con_id = modnode[MOD__TIMER].modname,
        .clk_hw = &clk_foo_modules[MOD__TIMER].hw,
    },
    [CLOCK__MAX + MOD__PWM5] = {
        .con_id = modnode[MOD__PWM5].modname,
        .clk_hw = &clk_foo_modules[MOD__PWM5].hw,
    },
    [CLOCK__MAX + MOD__PWM4] = {
        .con_id = modnode[MOD__PWM4].modname,
        .clk_hw = &clk_foo_modules[MOD__PWM4].hw,
    },
    [CLOCK__MAX + MOD__PWM3] = {
        .con_id = modnode[MOD__PWM3].modname,
        .clk_hw = &clk_foo_modules[MOD__PWM3].hw,
    },
    [CLOCK__MAX + MOD__PWM2] = {
        .con_id = modnode[MOD__PWM2].modname,
        .clk_hw = &clk_foo_modules[MOD__PWM2].hw,
    },
    [CLOCK__MAX + MOD__PWM1] = {
        .con_id = modnode[MOD__PWM1].modname,
        .clk_hw = &clk_foo_modules[MOD__PWM1].hw,
    },
    [CLOCK__MAX + MOD__PWM0] = {
        .con_id = modnode[MOD__PWM0].modname,
        .clk_hw = &clk_foo_modules[MOD__PWM0].hw,
    },
    [CLOCK__MAX + MOD__ETHERNET] = {
        .con_id = modnode[MOD__ETHERNET].modname,
        .clk_hw = &clk_foo_modules[MOD__ETHERNET].hw,
    },
    [CLOCK__MAX + MOD__UART5] = {
        .con_id = modnode[MOD__UART5].modname,
        .clk_hw = &clk_foo_modules[MOD__UART5].hw,
    },
    [CLOCK__MAX + MOD__UART4] = {
        .con_id = modnode[MOD__UART4].modname,
        .clk_hw = &clk_foo_modules[MOD__UART4].hw,
    },
    [CLOCK__MAX + MOD__UART3] = {
        .con_id = modnode[MOD__UART3].modname,
        .clk_hw = &clk_foo_modules[MOD__UART3].hw,
    },
    [CLOCK__MAX + MOD__UART6] = {
        .con_id = modnode[MOD__UART6].modname,
        .clk_hw = &clk_foo_modules[MOD__UART6].hw,
    },
    [CLOCK__MAX + MOD__PCM1] = {
        .con_id = modnode[MOD__PCM1].modname,
        .clk_hw = &clk_foo_modules[MOD__PCM1].hw,
    },
    [CLOCK__MAX + MOD__I2C1] = {
        .con_id = modnode[MOD__I2C1].modname,
        .clk_hw = &clk_foo_modules[MOD__I2C1].hw,
    },
    [CLOCK__MAX + MOD__I2C0] = {
        .con_id = modnode[MOD__I2C0].modname,
        .clk_hw = &clk_foo_modules[MOD__I2C0].hw,
    },
    [CLOCK__MAX + MOD__SPI3] = {
        .con_id = modnode[MOD__SPI3].modname,
        .clk_hw = &clk_foo_modules[MOD__SPI3].hw,
    },
    [CLOCK__MAX + MOD__SPI2] = {
        .con_id = modnode[MOD__SPI2].modname,
        .clk_hw = &clk_foo_modules[MOD__SPI2].hw,
    },
    [CLOCK__MAX + MOD__SPI1] = {
        .con_id = modnode[MOD__SPI1].modname,
        .clk_hw = &clk_foo_modules[MOD__SPI1].hw,
    },
    [CLOCK__MAX + MOD__SPI0] = {
        .con_id = modnode[MOD__SPI0].modname,
        .clk_hw = &clk_foo_modules[MOD__SPI0].hw,
    },
    [CLOCK__MAX + MOD__IRC] = {
        .con_id = modnode[MOD__IRC].modname,
        .clk_hw = &clk_foo_modules[MOD__IRC].hw,
    },
    [CLOCK__MAX + MOD__UART2] = {
        .con_id = modnode[MOD__UART2].modname,
        .clk_hw = &clk_foo_modules[MOD__UART2].hw,
    },
    [CLOCK__MAX + MOD__UART1] = {
        .con_id = modnode[MOD__UART1].modname,
        .clk_hw = &clk_foo_modules[MOD__UART1].hw,
    },
    [CLOCK__MAX + MOD__UART0] = {
        .con_id = modnode[MOD__UART0].modname,
        .clk_hw = &clk_foo_modules[MOD__UART0].hw,
    },
    [CLOCK__MAX + MOD__HDMI] = {
        .con_id = modnode[MOD__HDMI].modname,
        .clk_hw = &clk_foo_modules[MOD__HDMI].hw,
    },
    [CLOCK__MAX + MOD__SS] = {
        .con_id = modnode[MOD__SS].modname,
        .clk_hw = &clk_foo_modules[MOD__SS].hw,
    },
    [CLOCK__MAX + MOD__TV24M] = {
        .con_id = modnode[MOD__TV24M].modname,
        .clk_hw = &clk_foo_modules[MOD__TV24M].hw,
    },
    [CLOCK__MAX + MOD__CVBS_CLK108M] = {
        .con_id = modnode[MOD__CVBS_CLK108M].modname,
        .clk_hw = &clk_foo_modules[MOD__CVBS_CLK108M].hw,
    },
    [CLOCK__MAX + MOD__TVOUT] = {
        .con_id = modnode[MOD__TVOUT].modname,
        .clk_hw = &clk_foo_modules[MOD__TVOUT].hw,
    },
};
...
void atm7059_prepare_clocktree(void)
{
	...
	owl_clks[CLOCK__IC_32K]->core->prepare_count++;
	owl_clks[CLOCK__IC_32K]->core->enable_count++;

	if (read_clkreg_val(&enablebit_HOSC) == 1) {
		owl_clks[CLOCK__HOSC]->core->prepare_count++;
		owl_clks[CLOCK__HOSC]->core->enable_count++;
	}

	if (owl_clks[CLOCK__HOSC]->core->enable_count) {
		for (i = 0; i < PLL__MAX; i++) {
			if (pllnode[i].reg_pllen && read_clkreg_val(pllnode[i].reg_pllen) == 1) {
				owl_clks[CLOCK__HOSC]->core->prepare_count++;
				owl_clks[CLOCK__HOSC]->core->enable_count++;
				owl_clks[CLOCK__COREPLL + i]->core->prepare_count++;
				owl_clks[CLOCK__COREPLL + i]->core->enable_count++;
			}
		}
	}

	owl_clks[CLOCK__MAX + MOD__ROOT]->core->prepare_count++;
	owl_clks[CLOCK__MAX + MOD__ROOT]->core->enable_count++;
	for (i = 1; i < MOD__MAX_IN_CLK; i++) {
		if (modnode[i].reg_devclken && read_clkreg_val(modnode[i].reg_devclken) == 1) {
			owl_clks[CLOCK__MAX + MOD__ROOT]->core->prepare_count++;
			owl_clks[CLOCK__MAX + MOD__ROOT]->core->enable_count++;
			owl_clks[CLOCK__MAX + i]->core->prepare_count++;
			owl_clks[CLOCK__MAX + i]->core->enable_count++;
		}
	}
}
